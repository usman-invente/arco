        ...
        <div class="container">
            ...
            <div class="row" @if(LaravelLocalization::getCurrentLocale() === 'ar') style="text-align: right;" @endif>
                ...
                <h2 class="section-heading">
                    <img src="{{ asset('public/upload/news/'.Session::get('news')['image']) }}">
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <h2 class="color-secondary"><span class="color-primary">   {{ Session::get('news')['address']}}</span> </h2>
                    {{-- @if(LaravelLocalization::getCurrentLocale() === 'ar')
