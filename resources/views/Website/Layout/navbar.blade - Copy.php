                ...
                <div class="col-sm-8 col-md-6">
                    @if(LaravelLocalization::getCurrentLocale() === 'ar')
                            <div class="info pull-left">
                                <div class="info-item">
                                    <span class="fa fa-envelope-o fa-fw"></span> <a href="mailto:info@arco.com" title=""><strong>Mail:</strong> {{ $contact_us->email }}</a>
                                </div>
                                <div class=" info-item" style="margin-left:13px;">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="{{ URL('/') }}">
                    <img src="{{ asset('public/upload/web-logo/'.$logos[0]->logo) }}" alt="" style="width: 320px; height:70px;"  />
                </a>
