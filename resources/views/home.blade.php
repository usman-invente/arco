...
<div class="br-mainpanel">
    <div class="pd-30">
      <h4 class="tx-gray-800 mg-b-5">{{__('dashboard/lang.Dashboard') }}</h4>
    </div><!-- d-flex -->
        ...
        <div class="col-sm-6 col-xl-3">
          <div class="bg-teal rounded overflow-hidden">
            <div class="pd-25 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">{{__('dashboard/lang.Number Of Organizations') }}</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{$counter->no_of_organizations}}</p>
        ...
        <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
          <div class="bg-danger rounded overflow-hidden">
            <div class="pd-25 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">{{__('dashboard/lang.Number Of Volunteer Hours') }}</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{$counter->no_of_volunteer_hours}}</p>
                <span class="tx-11 tx-roboto tx-white-6"></span>
              </div>
            </div>
          </div>
        ...
        <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
          <div class="bg-primary rounded overflow-hidden">
            <div class="pd-25 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">{{__('dashboard/lang.Number Of Volunteer Opportunities') }}</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{$counter->no_of_volunteer_opportunities}}</p>
                <span class="tx-11 tx-roboto tx-white-6"></span>
              </div>
            </div>
          </div>
        ...
        <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
          <div class="bg-br-primary rounded overflow-hidden">
            <div class="pd-25 d-flex align-items-center">
              <i class="ion ion-clock tx-60 lh-0 tx-white op-7"></i>
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">{{__('dashboard/lang.Number Of Volunteers') }}</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{$counter->no_of_volunteer}}</p>
                <span class="tx-11 tx-roboto tx-white-6"></span>
              </div>
            </div>
          </div>
