    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                ...
                <form method="POST" action="{{ route('admin_update_organization',$organization->id) }}"
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="{{ __('dashboard/lang.Name') }}" name="name_en" value="{{$organization->name_en}}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="{{ __('dashboard/lang.Supervisor Name') }}" name="supervisor_name" value="{{$organization->supervisor_name}}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="{{ __('dashboard/lang.Email') }}" name="email" value="{{$organization->email}}">
                                    @if ($errors->has('email'))
                                        <span class="error" role="alert">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="{{ __('dashboard/lang.Contact Number') }}" name="contact" value="{{$organization->number}}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="{{ __('dashboard/lang.url') }}" name="site_url" value="{{$organization->site_url}}">
