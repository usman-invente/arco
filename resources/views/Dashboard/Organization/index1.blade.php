...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('admin_add_organization')}}" class="pull-right"> <button type="button" class="btn btn-success mr-1 mb-1">
                        <i class="feather icon-plus"></i>
                        {{__('dashboard/lang.Add Organization') }}
                    </button></a>
                                            ...
                                            <table class="table zero-configuration" id="vc">
                                                <thead>
                                                   ...
                                                   <th><input type="checkbox" class='checkall' id='checkall'></th>
                                                    ...
                                                    <th>{{__('dashboard/lang.SuperVisor') }}</th>
                                                    <th>{{__('dashboard/lang.Email') }} </th>
                                                    <th>{{__('dashboard/lang.Number') }} </th>
