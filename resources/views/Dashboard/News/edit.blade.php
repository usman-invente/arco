    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                ...
                <form method="POST" action="{{ route('site_update_news',$news->id)}}"
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('description') is-invalid @enderror" name="address" id="basicTextarea" value="{{$news->address}}" >
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                   ...
                                   <select class="form-control" name="organization_id">
                                       ...
                                       <option @if($organization->id == $news->organization_id) selected @endif value="{{$organization->id}}"> {{$organization->name_en}}</option>
                                       @endforeach
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="basicSelect" name="status_id">
                                        <option @if($news->status_id == 1) selected @endif   value="1">Published</option>
                                        <option  @if($news->status_id == 2) selected @endif   value="2">Not Published</option>
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror summernote" name="content" id="basicTextarea" rows="3" >{{$news->content}}</textarea>
