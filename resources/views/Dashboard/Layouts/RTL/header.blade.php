...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        @if (Auth::user()->role_id == 2)
            ...
            <a href="{{ route('admin_Volunteer_Supervisor') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.VS') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
            <a href="{{ route('admin_Volunteer_Opportunity_Officers') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.VOO') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
            <a href="{{ route('admin_volunteer_field') }}"
                class="br-menu-link {{ Route::currentRouteName() == 'admin_volunteer_field' ? 'active' : '' }}">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.AOVP') }} <br>
                        {{ __('dashboard/lang.opprtinity officer') }}
                    </span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->

            <a href="{{ route('admin_manage_Volunteer_Opportunity') }}"
                class="br-menu-link {{ Route::currentRouteName() == 'admin_manage_Volunteer_Opportunity' ? 'active' : '' }}">
                <div class="br-menu-item">
                    <i class="menu-item-icon ion-ios-redo-outline tx-24"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.MOV') }}</span>

                </div><!-- menu-item -->
            </a><!-- br-menu-link -->

            <a href="{{ route('admin_organization') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.National Societies') }}</span>

                </div><!-- menu-item -->
            </a><!-- br-menu-link -->

            <a href="{{ route('admin_reports') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.Reports') }}</span>

                </div><!-- menu-item -->
            </a><!-- br-menu-link -->

            <a href="{{ route('admin_volunteer') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-20"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.Volunteers') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->

            <a href="{{ route('admin_callus') }}" href="#" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-navigate-outline tx-24"></i>
                    <span class="menu-item-label">{{ __('dashboard/lang.Call US') }}</span>
            ...
            <a href="#" class="br-menu-link">
                <div class="br-menu-item">
                    ...
                    <span class="menu-item-label">{{ __('dashboard/lang.Account') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
        @endif
        <!--   side admin -->
        @if (Auth::user()->role_id == 6)
            ...
            <a  href="{{route('page')}}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
                    <span class="menu-item-label">{{__('dashboard/lang.Page Manager') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
            <a href="{{ route('site_news') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
                    <span class="menu-item-label">{{__('dashboard/lang.News') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
            <a href="{{ route('animated_slide') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
                    <span class="menu-item-label">{{__('dashboard/lang.Animated Slides') }}</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
        

            <a  href="{{route('counter')}}"
                class="br-menu-link {{ Route::currentRouteName() == 'counter' ? 'active' : '' }}">
                <div class="br-menu-item">
                    <i class="menu-item-icon ion-ios-redo-outline tx-24"></i>
                    <span class="menu-item-label">{{__('dashboard/lang.Counters') }}</span>

                </div><!-- menu-item -->
            </a><!-- br-menu-link -->

            <a href="{{ route('contact_us') }}" class="br-menu-link">
                <div class="br-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">{{__('dashboard/lang.Call US') }}</span>
