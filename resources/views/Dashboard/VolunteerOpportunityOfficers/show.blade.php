...
@if(!empty($user))
    <table class="table m-0 show_table" style="color: black;">
        ...
        <tr>
            <TH>{{__('dashboard/volunteers.data_table_title_13')}}  </TH><td>@if(!empty($user->person_picture)) <img src="{{ asset('public/images/users/opportunityOfficers/'.$user->person_picture) }}" style=" width: 300px; height: 200px;"> @else Not Found @endif</td>
        </tr>
        <tr>
        ...
        <tr>
            <TH>{{__('dashboard/volunteers.data_table_title_12')}}  </TH><td>@if(!empty($user->passport_picture)) <img src="{{ asset('public/images/users/opportunityOfficers/passport/'.$user->passport_picture) }}" style=" width: 300px; height: 200px;"> @else Not Found @endif</td>
        </tr>
