@extends('Dashboard.Layouts.RTL.layout',['title'=>__('dashboard/permissions.title') ])
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-light">{{__('dashboard/permissions.title_description')}}</h6>
                    </div>
                    <div class="pull-right">
{{--                        <h2><a href="javascript:add();" class="btn-primary btn"><i class="fa fa-plus" ></i> {{__('dashboard/permissions.add_button')}}</a>--}}
                        </h2>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="table-wrap">
                            <div class="table-responsive" style="color: black;">
                                <table id="permission_dataTable" class="table table-bordered table-striped table-hover  display  pb-30"  >
                                    <thead>
                                    <tr>
                                        <th>{{__('dashboard/permissions.data_table_title_1')}}</th>
                                        <th>{{__('dashboard/permissions.data_table_title_2')}}</th>
                                        <th>{{__('dashboard/permissions.data_table_title_3')}}</th>
                                    </tr>
                                    </thead>
                                    <tbody >
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" permission="dialog" aria-labelledby="exampleModalLabel1">
                    <div class="modal-dialog" permission="document">

                        <div class="modal-content"  style="width: 800px;">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h5 class="modal-title" id="exampleModalLabel1">{{__('dashboard/permissions.title_description')}}</h5>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#datable_1 tbody').on('click', '.edit', function (e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{URL('/dashboard/permissions')}}" + "/" + id + "/edit",
                    contentType: "html",
                    dataType: 'html',
                    success: function (data) {
        ...
        function add() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{URL("/dashboard/permissions/create")}}",
                contentType: "html",
                dataType: 'html',
                success: function (data) {
