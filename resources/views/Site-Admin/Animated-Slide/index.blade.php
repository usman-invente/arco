    ...
    <div class="br-mainpanel">
        <div class="br-pagebody">
            ...
            <div class="row" style="margin-top:30px;">
                <div class="col-md-12">
                    <a  href="{{route('add_animated_slide')}}"  class="pull-right"> <button type="button"
                            class="btn btn-success mr-1 mb-1">
                            <i class="fa fa-plus"></i>
                            {{__('dashboard/lang.Add Animated Slide') }}
                        </button></a>
                    ...
                    <table id="vc" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>{{__('dashboard/lang.Image') }} </th>
                                <th>{{__('dashboard/lang.Sequence') }}</th>
