    ...
    <div class="br-mainpanel">
        <div class="br-pagebody">
            ...
            <div class="row" style="margin-top:30px;">
                <div class="col-md-12">
                    <a  href="{{ route('site_add_news') }}" class="pull-right"> <button type="button"
                    ...
                    <table id="vc" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p">{{__('dashboard/lang.Address') }}</th>
                                <th>{{__('dashboard/lang.Status') }}</th>
                                <th>{{__('dashboard/lang.Created_BY') }}</th>
