...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Create Volunteer Opportunity</h4>
        </div>
                ...
                <form class="form">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-label-group">
                                    <input type="file" id="email-id-column" class="form-control @error('slider_image') is-invalid @enderror" name="slider_image" placeholder="Slider Image">
                                    @error('slider_image')	
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-control" id="basicSelect" name="status">
                                    ...
                                    <option value="Deactive">Not Published</option>
                                </select>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <textarea class="form-control @error('description') is-invalid @enderror"name="description" id="basicTextarea" rows="3" placeholder="Description"></textarea>
                                        @error('description')	
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
